...
const apps: AppManifest[] = [
  ...
  { id: "dashboard", name: "Activity", icon: "activity", category: "platform", component: () => import("@/apps/DashboardApp").then((m) => ({ default: m.DashboardApp })), defaultSize: { w: 1100, h: 720 }, minSize: { w: 600, h: 400 }, singleton: true, pinned: false, launchpadOrder: 7 },
